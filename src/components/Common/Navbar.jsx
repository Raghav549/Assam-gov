...
<>
  ...
  {/* MOBILE MENU */}
  <div
    className={`fixed top-0 right-0 h-screen w-[85%] max-w-[320px] bg-white z-[99999] shadow-2xl transform transition-transform duration-300 lg:hidden overflow-y-auto ${
