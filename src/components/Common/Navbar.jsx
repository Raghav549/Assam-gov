// ============================================
// FIXED PREMIUM RESPONSIVE NAVBAR COMPONENT
// ============================================
...
return (
<>
<nav className="fixed top-0 left-0 w-full z-[9999] bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center justify-between h-16">
        ...
        >
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-green-500 to-blue-600 flex items-center justify-center text-white font-bold text-sm shadow-lg">
            YA
          </div>
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          {user ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                to="/login"
                className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-green-600 transition-all"
              >
                Login
              </Link>
              ...
              <Link
                to="/signup"
                className="px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-green-500 to-blue-600 shadow-lg hover:scale-105 transition-all duration-300"
              >
                Sign Up
              </Link>
  ...
  {/* MOBILE MENU */}
  <div
    className={`fixed top-0 right-0 h-screen w-[85%] max-w-[320px] bg-white z-[99999] shadow-2xl transform transition-transform duration-300 lg:hidden ${
  ...
  >
    ...
    <div className="flex flex-col p-5 gap-2 overflow-y-auto h-full pb-32">
